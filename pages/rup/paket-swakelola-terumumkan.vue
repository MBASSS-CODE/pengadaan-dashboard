<template>
  <div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
      <div>
        <h1 class="text-2xl font-bold text-[color:hsl(var(--maz-foreground))]">Paket Swakelola Terumumkan</h1>
...
const loadData = async (force = false) => {
  ...
  error.value = false;
  try {
    const response = await $fetch('/api/data/rup/paket-swakelola-terumumkan', {
      params: { 
