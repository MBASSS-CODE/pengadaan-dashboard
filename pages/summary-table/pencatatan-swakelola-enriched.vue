<template>
  <div class="p-6 max-w-[1400px] mx-auto">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-[color:hsl(var(--maz-foreground))]">Pencatatan Swakelola (Merge)</h1>
        <p class="text-sm text-[color:hsl(var(--maz-muted))] mt-1">Daftar pencatatan paket pengadaan swakelola dengan data yang telah di-enrich (RUP, PPK, Realisasi)</p>
      </div>
...
<script setup>
import { ref } from 'vue';
import PencatatanSwakelolaEnrichedAnalytics from '~/components/summary-table/pencatatan-swakelola-enriched/PencatatanSwakelolaEnrichedAnalytics.vue';
import PencatatanSwakelolaEnrichedTable from '~/components/summary-table/pencatatan-swakelola-enriched/PencatatanSwakelolaEnrichedTable.vue';
