<template>
  <div class="p-6 max-w-[1400px] mx-auto">
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-[color:hsl(var(--maz-foreground))]">E-Purchasing Enriched</h1>
        <p class="text-sm text-[color:hsl(var(--maz-muted))] mt-1">Data E-Purchasing yang diperkaya dengan RUP Penyedia dan status UMKM</p>
      </div>
...
<script setup>
import { ref } from 'vue';
import EpurchasingEnrichedAnalytics from '~/components/summary-table/epurchasing-enriched/EpurchasingEnrichedAnalytics.vue';
import EpurchasingEnrichedTable from '~/components/summary-table/epurchasing-enriched/EpurchasingEnrichedTable.vue';
