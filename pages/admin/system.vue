<template>
  <div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="mt-8">
      <div class="bg-[color:hsl(var(--maz-background))] rounded-xl border border-[color:hsl(var(--maz-border))] shadow-sm overflow-hidden p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div>
          <h2 class="text-lg font-bold text-[color:hsl(var(--maz-foreground))] flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[color:hsl(var(--maz-primary))]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
          ...
          <p class="text-xs text-[color:hsl(var(--maz-muted))] mt-1">Kelola dan jalankan proses penggabungan data secara terpusat</p>
        </div>
        <NuxtLink to="/admin/data-merge">
          <MazBtn color="primary" size="sm">Kelola Merge Data</MazBtn>
        </NuxtLink>
      </div>
    </div>
  </div>
