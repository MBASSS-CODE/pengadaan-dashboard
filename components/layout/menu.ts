...
export const menuGroups: MenuGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/summary-table/rup-swakelola-enriched',
        iconPaths: [
          'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10'
        ]
      }
  ...
  },
  {
    label: 'Metode Pengadaan',
     items: [
      {
        name: 'Realisasi Pengadaan',
        path: '/summary-table/realisasi-pengadaan',
        iconPaths: [
          'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z'
        ]
      },
      {
        name: 'E-Purchasing Enriched',
        path: '/summary-table/epurchasing-enriched',
        iconPaths: [
          'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z'
        ]
      },
  ...
  {
    label: 'Data API Tender',
    items: [
      {
        name: 'Pengumuman Tender',
        path: '/tender/pengumuman',
        endpointActive: 'pengumuman',
        iconPaths: [
      ...
      {
        name: 'Peserta Tender',
        path: '/tender/peserta-tender',
        endpointActive: 'peserta-tender',
        iconPaths: [
          'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'
        ]
      },
      ...
      {
        name: 'Pencatatan Non-Tender Realisasi',
        path: '/tender/pencatatan-non-tender-realisasi',
        endpointActive: 'pencatatan-non-tender-realisasi',
        iconPaths: [
          'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'
        ]
      },
      ...
      {
        name: 'Pencatatan Swakelola Realisasi',
        path: '/tender/pencatatan-swakelola-realisasi',
        endpointActive: 'pencatatan-swakelola-realisasi',
        iconPaths: [
          'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'
        ]
      }
  ...
  {
    label: 'Data API e-Katalog',
    items: [
      {
        name: 'Paket e-Purchasing',
        path: '/ekatalog/paket-e-purchasing',
        endpointActive: 'paket-e-purchasing',
        iconPaths: [
          'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z'
        ]
      }
