<template>
  <ClientOnly>
    ...
    <!-- Detail Dialog -->
    <RupSwakelolaEnrichedDetailDialog v-model="isDetailOpen" :selected-row="selectedRow" />
    </div>
  </ClientOnly>
</template>
...
import RupSwakelolaEnrichedDetailDialog from './RupSwakelolaEnrichedDetailDialog.vue';
