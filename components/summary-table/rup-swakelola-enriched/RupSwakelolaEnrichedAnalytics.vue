<template>
  <div class="mb-6">
    ...
    <div class="mt-6 flex flex-col gap-6" v-if="!loading && !error && totalItems > 0">
    ...
    <div v-if="!loading && !error && totalItems === 0" class="mt-8 flex flex-col items-center justify-center min-h-[350px] text-center bg-[color:hsl(var(--maz-background))] rounded-2xl border border-dashed border-[color:hsl(var(--maz-border))] p-8">
      ...
      <p class="text-[color:hsl(var(--maz-muted))] max-w-md mx-auto mb-6 text-sm">
        Tidak ada data RUP Swakelola untuk tahun anggaran ini yang telah melalui proses integrasi (merge). Silakan jalankan proses integrasi data melalui menu Admin Sistem.
      </p>
