<template>
  <ClientOnly>
    <div class="flex flex-col gap-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-[color:hsl(var(--maz-background))] rounded-xl border border-[color:hsl(var(--maz-border))] p-4 shadow-[0_4px_15px_rgba(0,0,0,0.05)]">
          <div class="text-xs text-[color:hsl(var(--maz-muted))] font-medium uppercase tracking-wider mb-1">Total Paket Penyedia</div>
    ...
    <RupPenyediaEnrichedDetailDialog v-model="isDetailOpen" :selected-row="selectedRow" />
    </div>
  </ClientOnly>
</template>
...
import RupPenyediaEnrichedDetailDialog from './RupPenyediaEnrichedDetailDialog.vue';
